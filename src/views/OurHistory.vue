<template>
    <v-container fluid pa-2>
        <v-card >
            <h1 class="header">HERON HAVEN WETLAND-A WORK IN PROGRESS!</h1><br>
            <v-layout pa-0 row wrap>
                <v-flex sm12 md5 pa-2>
                    <v-img :src="waterReflection" ></v-img>
                </v-flex>
                <v-flex sm12 md7 pa-2>
            ...
            <v-layout row wrap>
                <v-flex sm12 md7  pa-2>
                    ...
                    scouts, lunches or catered dinners.</p>
                </v-flex>
                <v-flex sm12 md5  pa-2>
                    <v-img :src="boardwalk"></v-img>
                </v-flex>
            </v-layout>

            <v-layout row wrap>
                <v-flex sm12 md5  pa-2>
                    <v-img :src="snowyBench" ></v-img>
                </v-flex>
                <v-flex sm12 md7  pa-2>
                    ...
                    the area!</p><br>
                    <p>Saving Heron Haven is a "work in progress"!</p>
                </v-flex>
            </v-layout> 
        </v-card>
...
export default {
    data() {
        return {
            waterReflection: require('@/assets/about_us/water_reflection.jpg'),
            boardwalk: require('@/assets/about_us/boardwalk.jpg'),
            snowyBench: require('@/assets/about_us/snowy_bench-2.jpg'),
